...
@echo on
set OPENSSL_PATH=C:\Users\yuweiche\Code\Client\ClientMaster\Intel\AlderLakePlatSamplePkg\Tools\OpenSSL
cd ..\edk2\edk2\BaseTools\Source\Python\Rsa2048Sha256Sign
set CurrentWorkSpace = %CD%
echo %CurrentWorkSpace%

@%PYTHON_COMMAND% Rsa2048Sha256Sign.py %1 %2 %3 %4 --private-key %PRIVATE_KEY_PATH%

echo on
echo @%PYTHON_COMMAND% Rsa2048Sha256Sign.py %1 %2 %3 %4 --private-key %PRIVATE_KEY_PATH%
@if errorlevel 1 (
  @exit /b 1
)
